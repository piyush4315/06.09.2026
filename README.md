...
* **Then the GRAND TOTAL** of both, which always equals the source's own totals
  ...
  2,811,931 + 511,966 + 11,806,701 = 15,130,598 — and **TOTAL MATCHED + REMAINING = GRAND TOTAL**
  on every column, whatever is typed.
* Clear the box and all 37 lots come back in a single **ALL LOTS** block; REMAINING is empty, so
  TOTAL MATCHED is the whole list and the two summary rows agree.
